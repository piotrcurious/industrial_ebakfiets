...
The main cargo bed is supported by two parallel rails.
...
- **Dropout Plate**: 6mm-8mm laser-cut steel plates.
...
- **Rear Dropout Alignment**: Within +/- 1.0mm over the wheelbase length.
